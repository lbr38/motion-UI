                    ...
                    <div class="camera-btn-div flex">
                        <div class="flex justify-space-between align-item-center column-gap-20">
                            ...
                            <div class="flex align-item-center column-gap-10">
                                <!-- <div class="slide-btn-medium-tr display-ptz-btns" title="Display PTZ buttons" camera-id="<?= $cameraId ?>">
                                    <img src="/assets/icons/move.svg" />
                                    <span>Display PTZ buttons</span>
                                </div> -->
                        ...
                        <div class="camera-ptz-btn-container flex-direction-column margin-top-20 hide" camera-id="<?= $cameraId ?>">
                            <div class="flex column-gap-10 align-item-center justify-space-around">
                                ...
                                <!-- PTZ Intermittent move buttons -->
                                <div class="flex flex-direction-column align-item-center justify-center column-gap-10 row-gap-10">
                                    <img src="/assets/icons/up.svg" class="camera-ptz-btn icon-mediumopacity icon-large" title="Move up" camera-id="<?= $cameraId ?>" direction="up" move-type="intermittent" />
                                    
                                    <div class="flex align-item-center column-gap-45">
                                        <img src="/assets/icons/previous.svg" class="camera-ptz-btn icon-mediumopacity icon-large" title="Move left" camera-id="<?= $cameraId ?>" direction="left" move-type="intermittent" />
                                        <img src="/assets/icons/next.svg" class="camera-ptz-btn icon-mediumopacity icon-large" title="Move right" camera-id="<?= $cameraId ?>" direction="right" move-type="intermittent" />
                                    </div>

                                    <img src="/assets/icons/down.svg" class="camera-ptz-btn icon-mediumopacity icon-large" title="Move down" camera-id="<?= $cameraId ?>" direction="down" move-type="intermittent" />
                                </div>
                            </div>
