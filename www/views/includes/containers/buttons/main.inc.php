<section class="main-buttons-container reloadable-container" container="buttons/main">
    <?php
    if ($cameraTotal > 0) :
        if (STREAM_ON_LIVE_PAGE === true) : ?>
            <div class="item">
