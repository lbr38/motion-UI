...
<pre>Parameter: on_event_start<br>Value: /var/lib/motionui/tools/event --cam-id %t --register-event %v</pre>
<p>
    - Enable and edit this parameter to be sure that the event end will be take into account:
</p>

<pre>Parameter: on_event_end<br>Value: /var/lib/motionui/tools/event --end-event %v</pre>
<p>
...
<pre>Parameter: on_movie_end<br>Value : /var/lib/motionui/tools/event --event %v --file %f</pre>
<p>
...
<pre>Parameter: on_picture_save<br>Value: /var/lib/motionui/tools/event --event %v --file %f</pre>
<p>
