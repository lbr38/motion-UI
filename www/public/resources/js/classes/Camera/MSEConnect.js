class MSEConnect
{
    ...
    /**
     * Connect to a camera via MSE or MJPEG stream
     * @returns 
     */
    async connect()
    {
        ...
        // Create <video> element for the stream, if not exist
        Camera.createVideoStreamElement(self.id);
        ...
        // Define event functions and store them for later removal
    ...
    /**
     * Delete a specific event listener
    ...
    /**
     * Cleans up all event listeners from the video stream
     */
